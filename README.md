...
Personal knowledge base, articles, and development setup documentation.

## Structure

```
amk-content/
├── vibe-coding-setup/    # Claude Code configuration & workflow
│   ├── README.md         # Setup guide
│   ├── CLAUDE.md         # Global coding DNA
...
- Notion integration for rocks/tasks
