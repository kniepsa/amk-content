...
- Warm, golden lighting in photos
...
4. Events (calendar/special occasions)
5. Location/Reservation CTA

## Example Gamma Prompt

```
Create a presentation with:
- Light theme (cream background #FCFBF9)
- Dark text (#222222)
- Red accents (#BB0203) for CTAs and highlights
- Blue (#005F96) for secondary headers
- Traditional Bavarian restaurant aesthetic
- Warm, inviting, authentic feel
- Serif font for headlines, sans-serif for body
- Food and beer garden photography focus
```
