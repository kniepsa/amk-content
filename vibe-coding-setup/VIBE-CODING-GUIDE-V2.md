...
| **Task Tracking** | NEXT.md (solo) or sprint-status.yaml (BMM) | Focus management |
...
*Guide location: `~/projects/knibo/amk-content/vibe-coding-setup/VIBE-CODING-GUIDE-V2.md`*
*Version: 2.0.0*
